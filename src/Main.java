...
public class Main {
        ...
        while (opcion != 9) {
            ...
            switch (opcion) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    System.out.println("Por ahora no implementado");
    ...
    private void vendePasajes() {
        ...
        for (int i = 0; i < cant; i++) {
            ...
            if (sistema.getNombrePasajero(idPas) == null) {
                ...
                sistema.createPasajero(idPas, nom, "999", nom, "999");
            }
    ...
    private void listPasajerosViaje() {
        ...
        for (String[] fila : lista) {
            if (fila[0] != null) System.out.printf("| %-15s | %-30s | %-30s |", fila[0], fila[1], fila[2]);
        }
    }
